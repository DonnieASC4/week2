...
Information aboutt ASCII character codes: https://www.w3schools.com/charsets/ref_html_ascii.asp
Also check out this function to find ASCII character codes: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/charCodeAt

Ex.)

let str = "hi everybody";
let num = 8;
let numberKey = codeBreaker(str, num);
...
//////Reasoning/////
[Note 104 is the ASCII character code of the letter h and it is also divisible by 8
